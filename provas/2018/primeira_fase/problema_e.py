...
if salario_mensal <= 2999:
  ...
  # Calcular salário anual (12 meses + 13º)
  salario_anual = salario_mensal * 13
  # Determinar a alíquota com base no salário mensal
  if salario_mensal <= 4999:
    ...
    aliquota = 0.35
  # Calcular o imposto bruto antes de qualquer dedução
  imposto_bruto = salario_anual * aliquota
  # Calcular o percentual de desconto por dependentes
